...
from training.idr_train import OurTrainRunner
...
if __name__ == '__main__':
    ...
    parser.add_argument('--light_func', type=int, default=0, help='0: Spherical Gaussians, 1; Spherical Harmonics, 2: Spherical Wavelets')
    parser.add_argument('--dataset_type', type=int, default=0, help='0: synthetic dataset, 1: DTU dataset')

    parser.add_argument('--scan_id', type=int, default=-1, help='Scan id for DTU dataset')
    ...
    trainrunner = OurTrainRunner(conf=opt.conf,
